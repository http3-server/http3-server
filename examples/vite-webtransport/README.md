...
This example runs Vite and `http3s` as separate servers. Vite serves the page and hot
...
cached under this example's ignored `.http3s` directory. Its SHA-256 hash is injected
