# HTTP/3 Runtime for Linux arm64 with musl

`@http3-server/linux-arm64-musl` contains the prebuilt Node.js addon, MSH3 library, and
MsQuic library used by [`http3s`](https://www.npmjs.com/package/http3s) on musl-based
Linux arm64 systems such as Alpine Linux.
