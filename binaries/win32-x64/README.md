# HTTP/3 Runtime for Windows x64

`@http3-server/win32-x64` contains the prebuilt Node.js addon, MSH3 library, and MsQuic
library used by [`http3s`](https://www.npmjs.com/package/http3s) on Windows x64.
